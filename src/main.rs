...
use std::{fs, io::Write, collections::BTreeMap};
use lopdf::{Document, Object, Stream};
use lopdf::{ObjectId, Bookmark};
...
fn pdf_page_test()
    {
    let mut doc = Document::load("test_cases/wikimedia.pdf").unwrap();

    let mut doc_pages: BTreeMap<ObjectId, Object> = BTreeMap::new();
    let mut doc_objects: BTreeMap<ObjectId, Object>= BTreeMap::new();
